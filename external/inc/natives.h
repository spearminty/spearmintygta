...
namespace OBJECT
{
	...
	static Object GET_CLOSEST_OBJECT_OF_TYPE(float x, float y, float z, float radius, Hash modelHash, BOOL p5) { return invoke<Object>(0xE143FA2249364369, x, y, z, radius, modelHash, p5); } // 0xE143FA2249364369 0x45619B33
...
namespace CAM
{
	...
	static void POINT_CAM_AT_COORD(Any cameraHandle, float x, float y, float z) { invoke<Void>(0xF75497BB865F0803, cameraHandle, x, y, z); } // 0xF75497BB865F0803 0x914BC21A
...
namespace GRAPHICS
{
	...
	static void CLEAR_PLAYER_HAS_2_CHARACTERS_ENABLE(char* componentType) { invoke<Void>(0x80338406F3475E55, componentType); } // 0x80338406F3475E55 0x3AC9CB55
